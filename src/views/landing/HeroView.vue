		...
		<div class="mx-auto max-w-7xl lg:px-8">
			...
			<div class="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
				...
				<a href="#" class="inline-flex items-center rounded-full bg-black p-1 pr-2 text-white hover:text-gray-200 sm:text-base lg:text-sm xl:text-base">
					<span class="rounded-full bg-linear-to-r from-teal-500 to-cyan-600 px-3 py-0.5 text-sm font-semibold text-white">We're hiring</span>
					<span class="ml-4 text-sm">Visit our careers page</span>
					<ChevronRightIcon class="ml-2 size-5 text-gray-500" aria-hidden="true" />
				</a>
				<h1 class="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
					...
					<span class="block bg-linear-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">ship web apps</span>
				</h1>
				...
				<div class="mt-10 sm:mt-12">
					...
					<div class="sm:flex">
						...
						<input id="email" type="email" placeholder="Enter your email" class="block w-full rounded-md border-0 px-4 py-3 text-base text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-hidden" />
						</div>
						<div class="mt-3 sm:mt-0 sm:ml-3">
						<button type="submit" class="block w-full rounded-md bg-linear-to-r from-teal-500 to-cyan-600 px-4 py-3 font-medium text-white shadow-sm hover:from-teal-600 hover:to-cyan-700 focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-hidden">Start free trial</button>
						</div>
					</div>
			...
			<div class="mt-12 -mb-16 sm:-mb-48 lg:relative lg:m-0">
				...
				<img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="https://tailwindcss.com/plus-assets/img/component-images/cloud-illustration-teal-cyan.svg" alt="" />
				</div>
			</div>
			</div>
		</div>
